						...
						// Layer functions
							...
							if (keycode.includes('-') && !keycode.includes('>')) {
								...
								if (kc in _.invert(C.KEYPLUS_KEYCODES)) {
									...
									let modbit = 0;
									if (mods.includes('rC')) { modbit = modbit | 0b00010000; mods.replace(/rC/g, ''); }
									if (mods.includes('rS')) { modbit = modbit | 0b00100000; mods.replace(/rS/g, ''); }
									if (mods.includes('rA')) { modbit = modbit | 0b01000000; mods.replace(/rA/g, ''); }
									if (mods.includes('rG')) { modbit = modbit | 0b10000000; mods.replace(/rG/g, ''); }
									if (mods.includes('C')) { modbit = modbit | 0b00000001; }
									if (mods.includes('S')) { modbit = modbit | 0b00000010; }
									if (mods.includes('A')) { modbit = modbit | 0b00000100; }
									if (mods.includes('G')) { modbit = modbit | 0b00001000; }
